...
class ModifierManager {
    constructor() {
        this.registeredModifiers = new Map();
        this.acceptTypedModifierReference = new Map();
        this.returnTypeModifierReference = new Map();
        this.macros = new Map();

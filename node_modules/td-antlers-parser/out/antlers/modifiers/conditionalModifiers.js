const conditionalModifiers = [
    ...
    },
    {
        ...
        returnsType: ['boolean'],
        forFieldType: [],
        description: 'Tests if the string contains only alphabetic characters.',
        docLink: 'https://statamic.dev/modifiers/is_alpha',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    ...
    },
    {
        ...
        returnsType: ['boolean'],
        forFieldType: [],
        description: 'Tests if the value is an array.',
        docLink: 'https://statamic.dev/modifiers/is_array',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    ...
    },
    {
        ...
        returnsType: ['boolean'],
        forFieldType: [],
        description: 'Tests if the URL is external to the current site.',
        docLink: 'https://statamic.dev/modifiers/is_external_url',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    ...
    },
    {
        ...
        returnsType: ['boolean'],
        forFieldType: [],
        description: 'Tests if the provided number is Numberwang.',
        docLink: 'https://statamic.dev/modifiers/is_numberwang',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },

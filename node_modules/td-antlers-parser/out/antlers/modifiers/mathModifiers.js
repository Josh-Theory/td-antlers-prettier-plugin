const mathModifiers = [
    ...
    },
    {
        ...
        returnsType: ['number'],
        forFieldType: [],
        description: 'Returns the modulus (remainder) of dividing the value by the provided divisor.',
        docLink: 'https://statamic.dev/modifiers/mod',
        parameters: [
            {
                name: 'value',
...
//# sourceMappingURL=mathModifiers.js.map
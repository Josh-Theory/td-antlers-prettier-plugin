...
const arrayModifiers = [
    ...
    },
    {
        ...
        docLink: 'https://statamic.dev/modifiers/filter_empty',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    {
        ...
        returnsType: ['string'],
        forFieldType: [],
        description: 'Pluralizes the word based on the provided count.',
        docLink: 'https://statamic.dev/modifiers/plural',
        parameters: [
            {
                name: 'count',
                description: 'The number used to determine whether the word should be pluralized.'
            }
        ],
        canBeParameter: true,
        isDeprecated: false
    },
    {
        ...
        docLink: 'https://statamic.dev/modifiers/random',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    {
        ...
        returnsType: ['string'],
        forFieldType: [],
        description: 'Converts the array into a URL query string.',
        docLink: 'https://statamic.dev/modifiers/to_qs',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    {
        ...
        returnsType: ['array'],
        forFieldType: [],
        description: 'Filters the array to items where the given key is present in the provided list of values.',
        docLink: 'https://statamic.dev/modifiers/where-in',
        parameters: [
            {
                name: 'key',
                description: 'The property to filter by.'
            ...
            {
                name: 'values',
                description: 'The list of values to match against.'
            }
        ],
        canBeParameter: true,
        isDeprecated: false
...
//# sourceMappingURL=arrayModifiers.js.map
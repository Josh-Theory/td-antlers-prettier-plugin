const utilityModifiers = [
    ...
    },
    {
        ...
        returnsType: ['string'],
        forFieldType: [],
        description: 'Converts a hexadecimal color code to an RGB value.',
        docLink: 'https://statamic.dev/modifiers/hex_to_rgb',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    {
        ...
        returnsType: ['null'],
        forFieldType: [],
        description: 'Sends the variable data to the Ray desktop debugging application.',
        docLink: 'https://statamic.dev/modifiers/ray',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    }
...
//# sourceMappingURL=utilityModifiers.js.map
const stringModifiers = [
    ...
    },
    {
        ...
        returnsType: ['string'],
        forFieldType: [],
        description: 'Converts the string to a headline-style heading, capitalizing the first letter of every word.',
        docLink: 'https://statamic.dev/modifiers/headline',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    {
        ...
        docLink: 'https://statamic.dev/modifiers/kebab',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    {
        ...
        returnsType: ['array'],
        forFieldType: [],
        description: 'Parses a URL and returns an array of its components.',
        docLink: 'https://statamic.dev/modifiers/parse_url',
        parameters: [
            {
                name: 'component',
                description: 'The specific component of the URL to return.'
            }
        ],
        canBeParameter: true,
        isDeprecated: false
    },
    {
        name: 'pathinfo',
        acceptsType: ['string'],
        returnsType: ['array', 'string'],
        forFieldType: [],
        description: 'Returns information about a file path.',
        docLink: 'https://statamic.dev/modifiers/pathinfo',
        parameters: [
            {
                name: 'key',
                description: 'The specific piece of path information to return.'
            }
        ],
        canBeParameter: true,
        isDeprecated: false
    ...
    {
        name: 'rawurlencode_except_slashes',
        acceptsType: ['string'],
        returnsType: ['string'],
        forFieldType: [],
        description: 'URL-encodes the string according to RFC 3986, preserving forward slashes.',
        docLink: 'https://statamic.dev/modifiers/rawurlencode_except_slashes',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    {
        ...
        docLink: 'https://statamic.dev/modifiers/snake',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    {
        ...
        returnsType: ['string'],
        forFieldType: [],
        description: 'Pads the string on the left to a specified length with another string.',
        docLink: 'https://statamic.dev/modifiers/str_pad_left',
        parameters: [
            {
                name: 'length',
    ...
    },
    {
        ...
        returnsType: ['string'],
        forFieldType: [],
        description: 'Converts the string to StudlyCase.',
        docLink: 'https://statamic.dev/modifiers/studly',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    },
    {
        name: 'urlencode_except_slashes',
        acceptsType: ['string'],
        returnsType: ['string'],
        forFieldType: [],
        description: 'URL-encodes the string, preserving forward slashes.',
        docLink: 'https://statamic.dev/modifiers/urlencode_except_slashes',
        parameters: [],
        canBeParameter: false,
        isDeprecated: false
    }
...
//# sourceMappingURL=stringModifiers.js.map
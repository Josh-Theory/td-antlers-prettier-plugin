...
declare function dynamicParameter(name: string): IAntlersParameter;
...
declare function resultList(items: string[]): ICompletionResult;
declare function exclusiveResultList(items: string[]): ICompletionResult;
declare function exclusiveResult(items: CompletionItem[]): ICompletionResult;
declare function nonExclusiveResult(items: CompletionItem[]): ICompletionResult;
declare const EmptyCompletionResult: ICompletionResult;
interface IAntlersTag {
     ...
     */
    resolveDynamicParameter?(symbol: AntlersNode | null, paramName: string): IAntlersParameter | null;
    /**
...
export { IAntlersTag, IProviderCompletionResult, IAntlersParameter, exclusiveResultList, resultList, ICompletionResult, IRuntimeVariableType, dynamicParameter, EmptyCompletionResult, exclusiveResult, nonExclusiveResult };

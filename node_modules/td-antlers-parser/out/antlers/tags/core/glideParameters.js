...
import { exclusiveResultList, EmptyCompletionResult } from '../../tagManager.js';
const GlideFilters = ["greyscale", "sepia"];
const GlideFormats = [
    "jpg",
    "pjpg",
    "png",
...
const GlideOrients = ["auto", "0", "90", "180", "270"];
const GlideParameters = [
    {
        isRequired: false,
        name: "src",
        aliases: ["path", "id"],
...
export function resolveGlideParameterCompletions(parameter, params) {
...
//# sourceMappingURL=glideParameters.js.map
...
const AssetContainerParameters = ["container", "id", "handle"];
const Assets = {
    tagName: "assets",
    ...
    resolveCompletionItems: (params) => {
        if ((params.leftWord == "assets" || params.leftWord == "/assets") &&
            params.leftChar == ":") {
            return exclusiveResult(getAllAssetCompletions(params.project));
        }
        return EmptyCompletionResult;

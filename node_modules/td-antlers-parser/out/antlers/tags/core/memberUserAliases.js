...
const MemberTag = createDefinitionAlias(User, 'member'), MemberIs = createDefinitionAlias(UserIs, 'member:is'), MemberIsnt = createDefinitionAlias(UserIsnt, 'member:isnt'), MemberProfile = createDefinitionAlias(UserProfile, 'member:profile'), MemberCan = createDefinitionAlias(UserCan, 'member:can'), MemberLogout = createDefinitionAlias(UserLogout, 'member:logout'), MemberLogoutUrl = createDefinitionAlias(UserLogoutUrl, 'member:logout_url'), MemberIn = createDefinitionAlias(UserIn, 'member:in'), MemberNotIn = createDefinitionAlias(UserNotIn, 'member:not_in');
...
export { MemberTag, MemberIs, MemberIsnt, MemberProfile, MemberCan, MemberLogout, MemberLogoutUrl, MemberIn, MemberNotIn };
//# sourceMappingURL=memberUserAliases.js.map
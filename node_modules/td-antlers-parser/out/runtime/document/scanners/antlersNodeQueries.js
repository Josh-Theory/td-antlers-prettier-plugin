...
import { ConditionNode, ParserFailNode, AntlersNode } from '../../nodes/abstractNode.js';
export class AntlersNodeQueries {
    ...
    static findAncestorsBeforePosition(position, documentNodes) {
        const nodesToReturn = [];
        const skippedNodes = [];
        let forceSkipLine = -1, forceSkipOffset = -1; // Hold a reference to each symbol we've skipped on purpose.
...
//# sourceMappingURL=antlersNodeQueries.js.map
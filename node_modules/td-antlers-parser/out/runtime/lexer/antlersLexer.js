...
export class AntlersLexer {
    ...
    guardAgainstNeighboringTypesInModifier(current) {
        if (this.lastNode instanceof ModifierValueNode) {
            this.pushError(AntlersError.makeSyntaxError(AntlersErrorCodes.TYPE_MODIFIER_INCORRECT_VALUE_POSITION, this.lastNode, 'Incorrect type [' + TypeLabeler.getPrettyTypeName(current)
        ...
        for (this.currentIndex; this.currentIndex < this.inputLen; this.currentIndex += 1) {
            ...
            if (this.isParsingString == false) {
                ...
                if (this.isParsingModifierName == false && this.cur == DocumentParser.Punctuation_Minus) {
                    if (StringUtilities.ctypeDigit(this.next) && (StringUtilities.ctypeDigit(this.prev) == false &&
...
//# sourceMappingURL=antlersLexer.js.map